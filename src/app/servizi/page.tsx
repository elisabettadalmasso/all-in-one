...
function Services() {
  const {
    ...
    loading,
    error,
  } = useFetch<ServiceDetail>("/data/servicesDetail.json");
            ...
            <div key={service.id} className="service-card-detail">
              ...
              <div className="service-content">
                <picture className="service-photo-small">
                  ...
                  <img
                    src={
                      service.fallback || service.photo.replace(".avif", ".jpg")
                    }
                    alt={service.title}
                  />
                </picture>
        ...
        <section className="brand-section">
          ...
          <div className="brand-filter">
            ...
            <button
              ...
              className={activeFilter === "lights" ? "active" : ""}
            >
              Luci
            </button>
            <button
            ...
            <button
              ...
              className={activeFilter === "structures" ? "active" : ""}
            >
              Strutture
            </button>
            <button
